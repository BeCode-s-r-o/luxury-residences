...
const MainMenu = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg order-lg-2">
      <button
        className="navbar-toggler d-block d-lg-none z-10"
        type="button"
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="d-block d-lg-none">
            <div className="logo">
              <Link href="/" className="d-block">
                <img src="/images/logo/logo_07_dark.png" alt="" width={200} />
              </Link>
            </div>
          </li>
          {/* End li */}
          ...
          {/*                    <Link href={menu.link} ><h6 className="mega-menu-title">{menu.title}</h6></Link>*/}
