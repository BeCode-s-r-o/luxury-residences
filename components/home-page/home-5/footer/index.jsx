        ...
        <div className="line-bg-wrapper position-relative pt-130 pb-60 lg-pt-100 lg-pb-40">
          <div className="row justify-content-between">
            <div className="col-lg-4 footer-intro mb-40">
              <div className="logo">
                <Link href="/">
                  <img src="/images/logo/logo_07_cropped.png" alt="brand" width={240}/>
                </Link>
              </div>
              <p className="text-white fs-18 mt-30 mb-40 md-mt-10 md-mb-20 pe-xxl-5">
                Vaša voľba pre bývanie.
              </p>
              <Social />
            </div>
            {/* End .col-lg-3  */}
          ...
          <p className="copyright text-center pt-30 m0">
            © 2020 - {currentYear} LR development.
          </p>
          <p> Web od <a href="https://becode.sk" target="_blank" rel="noopener noreferrer">BeCode s.r.o</a>
          </p>
        </div>
        {/* /.inner-wrapper */}
      </div>
