        ...
        <div className="row align-items-center" data-aos="fade-right">
          <div className="col-6">
            <Image
              width={256}
              height={181}
              src="/images/media/about_1.png"
              alt="media"
              className="lazy-img mt-40 mb-40 lg-mt-20 lg-mb-20 object-cover"
            />
            <Image
              width={200}
              height={181}
              src="/images/media/about_2.png"
              alt="media"
              className="lazy-img ms-auto mt-40 mb-40 lg-mt-20 lg-mb-20 object-cover"
            />
          </div>
          <div className="col-6">
            <Image
