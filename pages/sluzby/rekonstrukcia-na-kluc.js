                    ...
                    <div className="row">
                        <div className="col-xl-9 col-lg-8 order-lg-1">
                            <div className="service-details-meta ps-lg-5">
                                <h2 className="main-title tx-dark mb-30">Rekonštrukcia na kľuč</h2>
                                <p className="text-lg tx-dark">
                                    Nevyhovuje Vám súčasný obytný priestor a uvažujete o zmene vo Vašom byte alebo dome? Kúpili ste si starší byt alebo dom a ten Vám dispozične nevyhovuje? Ponúkame kompletné rekonštrukcie bytov, domov, bytových jadier alebo prerábky kúpeľní či kancelárskych priestorov.</p>
                                <p className="text-lg tx-dark">
                                    U nás rekonštrukciu vybavíte na jednom mieste! Pomôžeme Vám ju naprojektovať, vybrať vhodný materiál a zabezpečíme náš tím skúsených pracovníkov. Premeníme tak Váš starý priestor na nový moderný.                                </p>
                                <img
                                    src="/images/media/rekonstrukcia.png"
                                    alt="media"
                            ...
                            <div className="service-sidebar pe-xxl-5 md-mt-60">
                                <div className="service-category mb-40">
                                    ...
                                    <ul className="style-none">
                                        ...
                                        <li>
                                            <a href="/sluzby/stavba-rodinneho-domu-na-kluc">Stavba rodinného domu na kľúč</a>
                                        </li>
                                    </ul>
                                </div>
                                {/* /.service-category */}
