  ...
  return (
    <>
      ...
      {/*
        ...
        =====================================================
        */}
      <div className="fancy-short-banner-six d-lg-flex" id="contact">
        <div className="block-wrapper left-side d-flex justify-content-center justify-content-lg-end align-items-center" >
          <div className="inner-wrapper black-overlay px-2" data-aos="fade-right">
            <div className="row">
              <div className="col-xxl-8 col-xl-9 col-lg-10">
                ...
                <p className="m0 text-white text-lg pt-50 lg-pt-30 md-pt-10">
                  Napíšte nám a my Vám pomôžeme s jeho realizáciou.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="inner-wrapper md-pt-50 md-pb-90" data-aos="fade-left">
            <div className="row">
              <div className="col-xxl-10 col-lg-11 ms-auto">
                <h3 className="form-title tx-dark mb-50 lg-mb-30">Kontaktujte nás už dnes</h3>
          ...
          <div className="row">
            <div className="col-xl-5 col-lg-6" data-aos="fade-right">
              ...
              <Link href="/contact" className="btn-one fw-500">
                Zistiť viac <i className="fa-solid fa-angle-right" />
              </Link>
            </div>
            {/* End .col */}
